...
<div class="container mt-4">
    ...
    <form action="{{ route('surats.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('pengirim_tujuan') is-invalid @enderror" id="pengirim_tujuan" name="pengirim_tujuan" value="{{ old('pengirim_tujuan') }}" required>
